...
def main():
    ...
    # Left Buttons
    left_button_y = left_visualizer.y_offset + left_visualizer.height + 40  # Added more space
    left_next_button = pygame.Rect(150, left_button_y, button_width, button_height)
    left_back_button = pygame.Rect(50, left_button_y, button_width, button_height)
    # Right Buttons
    right_button_y = right_visualizer.y_offset + right_visualizer.height + 40  # Added more space
    right_next_button = pygame.Rect(WIDTH - 150 - button_width, right_button_y, button_width, button_height)
    right_back_button = pygame.Rect(WIDTH - 50 - button_width, right_button_y, button_width, button_height)
    # Reset Button
    ...
    while running:
        ...
        if left_visualizer.comparison_result is not None:
            ...
            y = left_next_button.y + button_height + 30
        ...
        if right_visualizer.comparison_result is not None:
            ...
            y = right_next_button.y + button_height + 30
